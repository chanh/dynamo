...
/// Disabled by default.
pub const CACHE_REUSE_WORKER_STAGES_ENABLED_ENV: &str = "DYN_CACHE_REUSE_WORKER_STAGES_ENABLED";

static CACHE_REUSE_WORKER_STAGES_ENABLED: LazyLock<bool> =
    LazyLock::new(|| dynamo_truthy::env_is_truthy(CACHE_REUSE_WORKER_STAGES_ENABLED_ENV));
...
pub fn cache_reuse_worker_stages_enabled() -> bool {
